package com.react.spring.first.project.demo.web;
...
import com.react.spring.first.project.demo.model.User;
import com.react.spring.first.project.demo.model.UserRepository;
...
class GroupController {
    ...
    @PostMapping("/group")
    ResponseEntity<Group> createGroup(@RequestBody Group group, @AuthenticationPrincipal OAuth2User principal)
